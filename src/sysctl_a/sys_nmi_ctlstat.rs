...
pub type CS_FLG_R = crate::BitReader<CS_FLG_ENUM_READ_A>;
#[doc = "CS interrupt was the source of NMI\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CS_FLG_ENUM_READ_A {
    #[doc = "0: indicates CS interrupt was not the source of NMI"]
    CS_FLG_0 = 0,
    #[doc = "1: indicates CS interrupt was the source of NMI"]
    CS_FLG_1 = 1,
}
impl From<CS_FLG_ENUM_READ_A> for bool {
    #[inline(always)]
    fn from(variant: CS_FLG_ENUM_READ_A) -> Self {
        variant as u8 != 0
    }
}
impl CS_FLG_R {
...
impl PCM_FLG_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PCM_FLG_ENUM_READ_A {
        match self.bits {
            false => PCM_FLG_ENUM_READ_A::PCM_FLG_0,
            true => PCM_FLG_ENUM_READ_A::PCM_FLG_1,
        }
    }
    #[doc = "Checks if the value of the field is `PCM_FLG_0`"]
    #[inline(always)]
    pub fn is_pcm_flg_0(&self) -> bool {
        *self == PCM_FLG_ENUM_READ_A::PCM_FLG_0
    }
    #[doc = "Checks if the value of the field is `PCM_FLG_1`"]
    #[inline(always)]
    pub fn is_pcm_flg_1(&self) -> bool {
        *self == PCM_FLG_ENUM_READ_A::PCM_FLG_1
    }
}
