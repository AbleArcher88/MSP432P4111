...
#[doc = "CRC32DI (rw) register accessor: an alias for `Reg<CRC32DI_SPEC>`"]
pub type CRC32DI = crate::Reg<crc32di::CRC32DI_SPEC>;
#[doc = "Data Input for CRC32 Signature Computation"]
pub mod crc32di;
#[doc = "CRC32DIRB (rw) register accessor: an alias for `Reg<CRC32DIRB_SPEC>`"]
pub type CRC32DIRB = crate::Reg<crc32dirb::CRC32DIRB_SPEC>;
#[doc = "Data In Reverse for CRC32 Computation"]
pub mod crc32dirb;
#[doc = "CRC32INIRES_LO (rw) register accessor: an alias for `Reg<CRC32INIRES_LO_SPEC>`"]
...
#[doc = "CRC32INIRES_HI (rw) register accessor: an alias for `Reg<CRC32INIRES_HI_SPEC>`"]
