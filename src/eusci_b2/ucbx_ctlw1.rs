...
pub struct R(crate::R<UCBX_CTLW1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCBX_CTLW1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCBX_CTLW1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCBX_CTLW1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCBxCTLW1` writer"]
pub struct W(crate::W<UCBX_CTLW1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCBX_CTLW1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCBX_CTLW1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCBX_CTLW1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCGLIT_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, UCBX_CTLW1_SPEC, u8, UCGLIT_A, 2, O>;
...
pub type UCASTP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, UCBX_CTLW1_SPEC, u8, UCASTP_A, 2, O>;
...
pub type UCSWACK_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW1_SPEC, UCSWACK_A, O>;
...
pub type UCSTPNACK_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW1_SPEC, UCSTPNACK_A, O>;
...
pub type UCCLTO_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, UCBX_CTLW1_SPEC, u8, UCCLTO_A, 2, O>;
...
pub type UCETXINT_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW1_SPEC, UCETXINT_A, O>;
...
pub struct UCBX_CTLW1_SPEC;
impl crate::RegisterSpec for UCBX_CTLW1_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucbx_ctlw1::R](R) reader structure"]
impl crate::Readable for UCBX_CTLW1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucbx_ctlw1::W](W) writer structure"]
impl crate::Writable for UCBX_CTLW1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCBxCTLW1 to value 0x03"]
impl crate::Resettable for UCBX_CTLW1_SPEC {
    #[inline(always)]
