...
pub struct R(crate::R<UCBX_I2COA0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCBX_I2COA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCBX_I2COA0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCBX_I2COA0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCBxI2COA0` writer"]
pub struct W(crate::W<UCBX_I2COA0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCBX_I2COA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCBX_I2COA0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCBX_I2COA0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type I2COA0_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCBX_I2COA0_SPEC, u16, u16, 10, O>;
...
pub type UCOAEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_I2COA0_SPEC, UCOAEN_A, O>;
...
pub type UCGCEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_I2COA0_SPEC, UCGCEN_A, O>;
...
pub struct UCBX_I2COA0_SPEC;
impl crate::RegisterSpec for UCBX_I2COA0_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucbx_i2coa0::R](R) reader structure"]
impl crate::Readable for UCBX_I2COA0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucbx_i2coa0::W](W) writer structure"]
impl crate::Writable for UCBX_I2COA0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCBxI2COA0 to value 0"]
impl crate::Resettable for UCBX_I2COA0_SPEC {
    #[inline(always)]
