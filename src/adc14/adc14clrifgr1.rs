...
pub enum CLRADC14INIFG_ENUM_WRITE_AW {
    #[doc = "0: no effect"]
    CLRADC14INIFG_0 = 0,
    #[doc = "1: clear pending interrupt flag"]
    CLRADC14INIFG_1 = 1,
}
impl From<CLRADC14INIFG_ENUM_WRITE_AW> for bool {
    #[inline(always)]
    fn from(variant: CLRADC14INIFG_ENUM_WRITE_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CLRADC14INIFG` writer - clear ADC14INIFG"]
pub type CLRADC14INIFG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ADC14CLRIFGR1_SPEC, CLRADC14INIFG_ENUM_WRITE_AW, O>;
impl<'a, const O: u8> CLRADC14INIFG_W<'a, O> {
    #[doc = "no effect"]
    #[inline(always)]
    pub fn clradc14inifg_0(self) -> &'a mut W {
        self.variant(CLRADC14INIFG_ENUM_WRITE_AW::CLRADC14INIFG_0)
    }
    #[doc = "clear pending interrupt flag"]
    #[inline(always)]
    pub fn clradc14inifg_1(self) -> &'a mut W {
        self.variant(CLRADC14INIFG_ENUM_WRITE_AW::CLRADC14INIFG_1)
    }
}
#[doc = "clear ADC14LOIFG\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CLRADC14LOIFG_ENUM_WRITE_AW {
    #[doc = "0: no effect"]
    CLRADC14LOIFG_0 = 0,
    #[doc = "1: clear pending interrupt flag"]
    CLRADC14LOIFG_1 = 1,
}
impl From<CLRADC14LOIFG_ENUM_WRITE_AW> for bool {
    #[inline(always)]
    fn from(variant: CLRADC14LOIFG_ENUM_WRITE_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CLRADC14LOIFG` writer - clear ADC14LOIFG"]
pub type CLRADC14LOIFG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ADC14CLRIFGR1_SPEC, CLRADC14LOIFG_ENUM_WRITE_AW, O>;
impl<'a, const O: u8> CLRADC14LOIFG_W<'a, O> {
    #[doc = "no effect"]
    #[inline(always)]
    pub fn clradc14loifg_0(self) -> &'a mut W {
        self.variant(CLRADC14LOIFG_ENUM_WRITE_AW::CLRADC14LOIFG_0)
    }
    #[doc = "clear pending interrupt flag"]
    #[inline(always)]
    pub fn clradc14loifg_1(self) -> &'a mut W {
        self.variant(CLRADC14LOIFG_ENUM_WRITE_AW::CLRADC14LOIFG_1)
    }
}
#[doc = "clear ADC14HIIFG\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CLRADC14HIIFG_ENUM_WRITE_AW {
    #[doc = "0: no effect"]
    CLRADC14HIIFG_0 = 0,
    #[doc = "1: clear pending interrupt flag"]
    CLRADC14HIIFG_1 = 1,
}
impl From<CLRADC14HIIFG_ENUM_WRITE_AW> for bool {
    #[inline(always)]
    fn from(variant: CLRADC14HIIFG_ENUM_WRITE_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CLRADC14HIIFG` writer - clear ADC14HIIFG"]
pub type CLRADC14HIIFG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ADC14CLRIFGR1_SPEC, CLRADC14HIIFG_ENUM_WRITE_AW, O>;
impl<'a, const O: u8> CLRADC14HIIFG_W<'a, O> {
    #[doc = "no effect"]
    #[inline(always)]
    pub fn clradc14hiifg_0(self) -> &'a mut W {
        self.variant(CLRADC14HIIFG_ENUM_WRITE_AW::CLRADC14HIIFG_0)
    }
    #[doc = "clear pending interrupt flag"]
    #[inline(always)]
    pub fn clradc14hiifg_1(self) -> &'a mut W {
        self.variant(CLRADC14HIIFG_ENUM_WRITE_AW::CLRADC14HIIFG_1)
    }
}
#[doc = "clear ADC14OVIFG\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CLRADC14OVIFG_ENUM_WRITE_AW {
    #[doc = "0: no effect"]
    CLRADC14OVIFG_0 = 0,
    #[doc = "1: clear pending interrupt flag"]
    CLRADC14OVIFG_1 = 1,
}
impl From<CLRADC14OVIFG_ENUM_WRITE_AW> for bool {
    #[inline(always)]
    fn from(variant: CLRADC14OVIFG_ENUM_WRITE_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CLRADC14OVIFG` writer - clear ADC14OVIFG"]
pub type CLRADC14OVIFG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ADC14CLRIFGR1_SPEC, CLRADC14OVIFG_ENUM_WRITE_AW, O>;
impl<'a, const O: u8> CLRADC14OVIFG_W<'a, O> {
    #[doc = "no effect"]
    #[inline(always)]
    pub fn clradc14ovifg_0(self) -> &'a mut W {
        self.variant(CLRADC14OVIFG_ENUM_WRITE_AW::CLRADC14OVIFG_0)
    }
    #[doc = "clear pending interrupt flag"]
    #[inline(always)]
    pub fn clradc14ovifg_1(self) -> &'a mut W {
        self.variant(CLRADC14OVIFG_ENUM_WRITE_AW::CLRADC14OVIFG_1)
    }
}
#[doc = "clear ADC14TOVIFG\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CLRADC14TOVIFG_ENUM_WRITE_AW {
    #[doc = "0: no effect"]
    CLRADC14TOVIFG_0 = 0,
    #[doc = "1: clear pending interrupt flag"]
    CLRADC14TOVIFG_1 = 1,
}
impl From<CLRADC14TOVIFG_ENUM_WRITE_AW> for bool {
    #[inline(always)]
    fn from(variant: CLRADC14TOVIFG_ENUM_WRITE_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CLRADC14TOVIFG` writer - clear ADC14TOVIFG"]
pub type CLRADC14TOVIFG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ADC14CLRIFGR1_SPEC, CLRADC14TOVIFG_ENUM_WRITE_AW, O>;
impl<'a, const O: u8> CLRADC14TOVIFG_W<'a, O> {
    #[doc = "no effect"]
    #[inline(always)]
    pub fn clradc14tovifg_0(self) -> &'a mut W {
        self.variant(CLRADC14TOVIFG_ENUM_WRITE_AW::CLRADC14TOVIFG_0)
    }
    #[doc = "clear pending interrupt flag"]
    #[inline(always)]
    pub fn clradc14tovifg_1(self) -> &'a mut W {
        self.variant(CLRADC14TOVIFG_ENUM_WRITE_AW::CLRADC14TOVIFG_1)
    }
}
#[doc = "clear ADC14RDYIFG\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CLRADC14RDYIFG_ENUM_WRITE_AW {
    #[doc = "0: no effect"]
    CLRADC14RDYIFG_0 = 0,
    #[doc = "1: clear pending interrupt flag"]
    CLRADC14RDYIFG_1 = 1,
}
impl From<CLRADC14RDYIFG_ENUM_WRITE_AW> for bool {
    #[inline(always)]
    fn from(variant: CLRADC14RDYIFG_ENUM_WRITE_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CLRADC14RDYIFG` writer - clear ADC14RDYIFG"]
pub type CLRADC14RDYIFG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ADC14CLRIFGR1_SPEC, CLRADC14RDYIFG_ENUM_WRITE_AW, O>;
impl<'a, const O: u8> CLRADC14RDYIFG_W<'a, O> {
    #[doc = "no effect"]
    #[inline(always)]
    pub fn clradc14rdyifg_0(self) -> &'a mut W {
        self.variant(CLRADC14RDYIFG_ENUM_WRITE_AW::CLRADC14RDYIFG_0)
    }
    #[doc = "clear pending interrupt flag"]
    #[inline(always)]
    pub fn clradc14rdyifg_1(self) -> &'a mut W {
        self.variant(CLRADC14RDYIFG_ENUM_WRITE_AW::CLRADC14RDYIFG_1)
    }
}
impl W {
