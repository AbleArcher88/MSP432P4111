...
pub type ADC14BUSY_R = crate::BitReader<ADC14BUSY_ENUM_READ_A>;
#[doc = "ADC14 busy\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADC14BUSY_ENUM_READ_A {
    #[doc = "0: No operation is active"]
    ADC14BUSY_0 = 0,
    #[doc = "1: A sequence, sample, or conversion is active"]
    ADC14BUSY_1 = 1,
}
impl From<ADC14BUSY_ENUM_READ_A> for bool {
    #[inline(always)]
    fn from(variant: ADC14BUSY_ENUM_READ_A) -> Self {
        variant as u8 != 0
    }
}
impl ADC14BUSY_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> ADC14BUSY_ENUM_READ_A {
        match self.bits {
            false => ADC14BUSY_ENUM_READ_A::ADC14BUSY_0,
            true => ADC14BUSY_ENUM_READ_A::ADC14BUSY_1,
        }
    }
    #[doc = "Checks if the value of the field is `ADC14BUSY_0`"]
    #[inline(always)]
    pub fn is_adc14busy_0(&self) -> bool {
        *self == ADC14BUSY_ENUM_READ_A::ADC14BUSY_0
    }
    #[doc = "Checks if the value of the field is `ADC14BUSY_1`"]
    #[inline(always)]
    pub fn is_adc14busy_1(&self) -> bool {
        *self == ADC14BUSY_ENUM_READ_A::ADC14BUSY_1
    }
}
