...
pub struct R(crate::R<UCAX_CTLW1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCAX_CTLW1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCAX_CTLW1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCAX_CTLW1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCAxCTLW1` writer"]
pub struct W(crate::W<UCAX_CTLW1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCAX_CTLW1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCAX_CTLW1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCAX_CTLW1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCGLIT_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, UCAX_CTLW1_SPEC, u8, UCGLIT_A, 2, O>;
...
pub struct UCAX_CTLW1_SPEC;
impl crate::RegisterSpec for UCAX_CTLW1_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucax_ctlw1::R](R) reader structure"]
impl crate::Readable for UCAX_CTLW1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucax_ctlw1::W](W) writer structure"]
impl crate::Writable for UCAX_CTLW1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCAxCTLW1 to value 0x03"]
impl crate::Resettable for UCAX_CTLW1_SPEC {
    #[inline(always)]
