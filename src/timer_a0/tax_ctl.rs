...
pub struct R(crate::R<TAX_CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TAX_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TAX_CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TAX_CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TAxCTL` writer"]
pub struct W(crate::W<TAX_CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TAX_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TAX_CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TAX_CTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TAIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TAX_CTL_SPEC, TAIFG_A, O>;
...
pub type TAIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, TAX_CTL_SPEC, TAIE_A, O>;
...
pub type TACLR_W<'a, const O: u8> = crate::BitWriter<'a, u16, TAX_CTL_SPEC, bool, O>;
...
pub type MC_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, TAX_CTL_SPEC, u8, MC_A, 2, O>;
...
pub type ID_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, TAX_CTL_SPEC, u8, ID_A, 2, O>;
...
pub type TASSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, TAX_CTL_SPEC, u8, TASSEL_A, 2, O>;
...
pub struct TAX_CTL_SPEC;
impl crate::RegisterSpec for TAX_CTL_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [tax_ctl::R](R) reader structure"]
impl crate::Readable for TAX_CTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tax_ctl::W](W) writer structure"]
impl crate::Writable for TAX_CTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TAxCTL to value 0"]
impl crate::Resettable for TAX_CTL_SPEC {
    #[inline(always)]
