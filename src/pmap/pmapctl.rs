...
pub type PMAPLOCKED_R = crate::BitReader<PMAPLOCKED_ENUM_READ_A>;
#[doc = "Port mapping lock bit\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PMAPLOCKED_ENUM_READ_A {
    #[doc = "0: Access to mapping registers is granted"]
    PMAPLOCKED_0 = 0,
    #[doc = "1: Access to mapping registers is locked"]
    PMAPLOCKED_1 = 1,
}
impl From<PMAPLOCKED_ENUM_READ_A> for bool {
    #[inline(always)]
    fn from(variant: PMAPLOCKED_ENUM_READ_A) -> Self {
        variant as u8 != 0
    }
}
impl PMAPLOCKED_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> PMAPLOCKED_ENUM_READ_A {
        match self.bits {
            false => PMAPLOCKED_ENUM_READ_A::PMAPLOCKED_0,
            true => PMAPLOCKED_ENUM_READ_A::PMAPLOCKED_1,
        }
    }
    #[doc = "Checks if the value of the field is `PMAPLOCKED_0`"]
    #[inline(always)]
    pub fn is_pmaplocked_0(&self) -> bool {
        *self == PMAPLOCKED_ENUM_READ_A::PMAPLOCKED_0
    }
    #[doc = "Checks if the value of the field is `PMAPLOCKED_1`"]
    #[inline(always)]
    pub fn is_pmaplocked_1(&self) -> bool {
        *self == PMAPLOCKED_ENUM_READ_A::PMAPLOCKED_1
    }
}
