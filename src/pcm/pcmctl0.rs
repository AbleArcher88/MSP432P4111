...
pub type CPM_R = crate::FieldReader<u8, CPM_ENUM_READ_A>;
#[doc = "Current Power Mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum CPM_ENUM_READ_A {
    #[doc = "0: LDO based Active Mode at Core voltage setting 0."]
    CPM_0 = 0,
    #[doc = "1: LDO based Active Mode at Core voltage setting 1."]
    CPM_1 = 1,
...
impl From<CPM_ENUM_READ_A> for u8 {
    #[inline(always)]
    fn from(variant: CPM_ENUM_READ_A) -> Self {
        variant as _
    }
}
impl CPM_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<CPM_ENUM_READ_A> {
        match self.bits {
            0 => Some(CPM_ENUM_READ_A::CPM_0),
            1 => Some(CPM_ENUM_READ_A::CPM_1),
            4 => Some(CPM_ENUM_READ_A::CPM_4),
            5 => Some(CPM_ENUM_READ_A::CPM_5),
            8 => Some(CPM_ENUM_READ_A::CPM_8),
            9 => Some(CPM_ENUM_READ_A::CPM_9),
            16 => Some(CPM_ENUM_READ_A::CPM_16),
            17 => Some(CPM_ENUM_READ_A::CPM_17),
            20 => Some(CPM_ENUM_READ_A::CPM_20),
            21 => Some(CPM_ENUM_READ_A::CPM_21),
            24 => Some(CPM_ENUM_READ_A::CPM_24),
            25 => Some(CPM_ENUM_READ_A::CPM_25),
            32 => Some(CPM_ENUM_READ_A::CPM_32),
            _ => None,
        }
    }
