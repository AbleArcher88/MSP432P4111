...
#[doc = "Field `ADDRESS` reader - Holds the (double-word-aligned) location of the unpopulated floating-point register space allocated on an exception stack frame."]
pub type ADDRESS_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ADDRESS` writer - Holds the (double-word-aligned) location of the unpopulated floating-point register space allocated on an exception stack frame."]
pub type ADDRESS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FPCAR_SPEC, u32, u32, 29, O>;
impl R {
    #[doc = "Bits 2:30 - Holds the (double-word-aligned) location of the unpopulated floating-point register space allocated on an exception stack frame."]
    #[inline(always)]
    pub fn address(&self) -> ADDRESS_R {
        ADDRESS_R::new(((self.bits >> 2) & 0x1fff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 2:30 - Holds the (double-word-aligned) location of the unpopulated floating-point register space allocated on an exception stack frame."]
