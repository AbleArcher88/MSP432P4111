...
pub struct R(crate::R<UCBX_CTLW0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCBX_CTLW0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCBX_CTLW0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCBX_CTLW0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCBxCTLW0` writer"]
pub struct W(crate::W<UCBX_CTLW0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCBX_CTLW0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCBX_CTLW0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCBX_CTLW0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCSWRST_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCSWRST_A, O>;
...
pub type UCTXSTT_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCTXSTT_A, O>;
...
pub type UCTXSTP_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCTXSTP_A, O>;
...
pub type UCTXNACK_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCTXNACK_A, O>;
...
pub type UCTR_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCTR_A, O>;
...
pub type UCTXACK_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCTXACK_A, O>;
...
pub type UCSSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, UCBX_CTLW0_SPEC, u8, UCSSEL_A, 2, O>;
...
pub type UCSYNC_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCSYNC_A, O>;
...
pub type UCMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, UCBX_CTLW0_SPEC, u8, UCMODE_A, 2, O>;
...
pub type UCMST_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCMST_A, O>;
...
pub type UCMM_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCMM_A, O>;
...
pub type UCSLA10_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCSLA10_A, O>;
...
pub type UCA10_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_CTLW0_SPEC, UCA10_A, O>;
...
pub struct UCBX_CTLW0_SPEC;
impl crate::RegisterSpec for UCBX_CTLW0_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucbx_ctlw0::R](R) reader structure"]
impl crate::Readable for UCBX_CTLW0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucbx_ctlw0::W](W) writer structure"]
impl crate::Writable for UCBX_CTLW0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCBxCTLW0 to value 0x01c1"]
impl crate::Resettable for UCBX_CTLW0_SPEC {
    #[inline(always)]
