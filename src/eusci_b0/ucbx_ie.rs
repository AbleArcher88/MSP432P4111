...
pub struct R(crate::R<UCBX_IE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCBX_IE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCBX_IE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCBX_IE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCBxIE` writer"]
pub struct W(crate::W<UCBX_IE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCBX_IE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCBX_IE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCBX_IE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCRXIE0_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCRXIE0_A, O>;
...
pub type UCTXIE0_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCTXIE0_A, O>;
...
pub type UCSTTIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCSTTIE_A, O>;
...
pub type UCSTPIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCSTPIE_A, O>;
...
pub type UCALIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCALIE_A, O>;
...
pub type UCNACKIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCNACKIE_A, O>;
...
pub type UCBCNTIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCBCNTIE_A, O>;
...
pub type UCCLTOIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCCLTOIE_A, O>;
...
pub type UCRXIE1_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCRXIE1_A, O>;
...
pub type UCTXIE1_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCTXIE1_A, O>;
...
pub type UCRXIE2_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCRXIE2_A, O>;
...
pub type UCTXIE2_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCTXIE2_A, O>;
...
pub type UCRXIE3_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCRXIE3_A, O>;
...
pub type UCTXIE3_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCTXIE3_A, O>;
...
pub type UCBIT9IE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBX_IE_SPEC, UCBIT9IE_A, O>;
...
pub struct UCBX_IE_SPEC;
impl crate::RegisterSpec for UCBX_IE_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucbx_ie::R](R) reader structure"]
impl crate::Readable for UCBX_IE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucbx_ie::W](W) writer structure"]
impl crate::Writable for UCBX_IE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCBxIE to value 0"]
impl crate::Resettable for UCBX_IE_SPEC {
    #[inline(always)]
