...
pub type P2IV_R = crate::FieldReader<u8, P2IV_ENUM_READ_A>;
#[doc = "Port 2 interrupt vector value"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum P2IV_ENUM_READ_A {
...
impl From<P2IV_ENUM_READ_A> for u8 {
    #[inline(always)]
    fn from(variant: P2IV_ENUM_READ_A) -> Self {
        variant as _
    }
}
impl P2IV_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<P2IV_ENUM_READ_A> {
        match self.bits {
            0 => Some(P2IV_ENUM_READ_A::P2IV_0),
            2 => Some(P2IV_ENUM_READ_A::P2IV_2),
            4 => Some(P2IV_ENUM_READ_A::P2IV_4),
            6 => Some(P2IV_ENUM_READ_A::P2IV_6),
            8 => Some(P2IV_ENUM_READ_A::P2IV_8),
            10 => Some(P2IV_ENUM_READ_A::P2IV_10),
            12 => Some(P2IV_ENUM_READ_A::P2IV_12),
            14 => Some(P2IV_ENUM_READ_A::P2IV_14),
            16 => Some(P2IV_ENUM_READ_A::P2IV_16),
            _ => None,
        }
    }
