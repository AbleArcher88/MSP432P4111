...
pub type P3IV_R = crate::FieldReader<u8, P3IV_ENUM_READ_A>;
#[doc = "Port 3 interrupt vector value\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum P3IV_ENUM_READ_A {
...
impl From<P3IV_ENUM_READ_A> for u8 {
    #[inline(always)]
    fn from(variant: P3IV_ENUM_READ_A) -> Self {
        variant as _
    }
}
impl P3IV_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<P3IV_ENUM_READ_A> {
        match self.bits {
            0 => Some(P3IV_ENUM_READ_A::P3IV_0),
            2 => Some(P3IV_ENUM_READ_A::P3IV_2),
            4 => Some(P3IV_ENUM_READ_A::P3IV_4),
            6 => Some(P3IV_ENUM_READ_A::P3IV_6),
            8 => Some(P3IV_ENUM_READ_A::P3IV_8),
            10 => Some(P3IV_ENUM_READ_A::P3IV_10),
            12 => Some(P3IV_ENUM_READ_A::P3IV_12),
            14 => Some(P3IV_ENUM_READ_A::P3IV_14),
            16 => Some(P3IV_ENUM_READ_A::P3IV_16),
            _ => None,
        }
    }
