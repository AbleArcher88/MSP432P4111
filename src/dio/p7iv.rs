...
pub type P7IV_R = crate::FieldReader<u8, P7IV_ENUM_READ_A>;
#[doc = "Port 7 interrupt vector value\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum P7IV_ENUM_READ_A {
...
impl From<P7IV_ENUM_READ_A> for u8 {
    #[inline(always)]
    fn from(variant: P7IV_ENUM_READ_A) -> Self {
        variant as _
    }
}
impl P7IV_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<P7IV_ENUM_READ_A> {
        match self.bits {
            0 => Some(P7IV_ENUM_READ_A::P7IV_0),
            2 => Some(P7IV_ENUM_READ_A::P7IV_2),
            4 => Some(P7IV_ENUM_READ_A::P7IV_4),
            6 => Some(P7IV_ENUM_READ_A::P7IV_6),
            8 => Some(P7IV_ENUM_READ_A::P7IV_8),
            10 => Some(P7IV_ENUM_READ_A::P7IV_10),
            12 => Some(P7IV_ENUM_READ_A::P7IV_12),
            14 => Some(P7IV_ENUM_READ_A::P7IV_14),
            16 => Some(P7IV_ENUM_READ_A::P7IV_16),
            _ => None,
        }
    }
