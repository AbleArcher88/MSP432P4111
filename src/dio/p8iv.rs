...
pub type P8IV_R = crate::FieldReader<u8, P8IV_ENUM_READ_A>;
#[doc = "Port 8 interrupt vector value"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum P8IV_ENUM_READ_A {
...
impl From<P8IV_ENUM_READ_A> for u8 {
    #[inline(always)]
    fn from(variant: P8IV_ENUM_READ_A) -> Self {
        variant as _
    }
}
impl P8IV_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<P8IV_ENUM_READ_A> {
        match self.bits {
            0 => Some(P8IV_ENUM_READ_A::P8IV_0),
            2 => Some(P8IV_ENUM_READ_A::P8IV_2),
            4 => Some(P8IV_ENUM_READ_A::P8IV_4),
            6 => Some(P8IV_ENUM_READ_A::P8IV_6),
            8 => Some(P8IV_ENUM_READ_A::P8IV_8),
            10 => Some(P8IV_ENUM_READ_A::P8IV_10),
            12 => Some(P8IV_ENUM_READ_A::P8IV_12),
            14 => Some(P8IV_ENUM_READ_A::P8IV_14),
            16 => Some(P8IV_ENUM_READ_A::P8IV_16),
            _ => None,
        }
    }
