...
pub type P6IV_R = crate::FieldReader<u8, P6IV_ENUM_READ_A>;
#[doc = "Port 6 interrupt vector value"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum P6IV_ENUM_READ_A {
...
impl From<P6IV_ENUM_READ_A> for u8 {
    #[inline(always)]
    fn from(variant: P6IV_ENUM_READ_A) -> Self {
        variant as _
    }
}
impl P6IV_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<P6IV_ENUM_READ_A> {
        match self.bits {
            0 => Some(P6IV_ENUM_READ_A::P6IV_0),
            2 => Some(P6IV_ENUM_READ_A::P6IV_2),
            4 => Some(P6IV_ENUM_READ_A::P6IV_4),
            6 => Some(P6IV_ENUM_READ_A::P6IV_6),
            8 => Some(P6IV_ENUM_READ_A::P6IV_8),
            10 => Some(P6IV_ENUM_READ_A::P6IV_10),
            12 => Some(P6IV_ENUM_READ_A::P6IV_12),
            14 => Some(P6IV_ENUM_READ_A::P6IV_14),
            16 => Some(P6IV_ENUM_READ_A::P6IV_16),
            _ => None,
        }
    }
