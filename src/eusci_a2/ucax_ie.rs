...
pub struct R(crate::R<UCAX_IE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCAX_IE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCAX_IE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCAX_IE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCAxIE` writer"]
pub struct W(crate::W<UCAX_IE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCAX_IE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCAX_IE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCAX_IE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCRXIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IE_SPEC, UCRXIE_A, O>;
...
pub type UCTXIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IE_SPEC, UCTXIE_A, O>;
...
pub type UCSTTIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IE_SPEC, UCSTTIE_A, O>;
...
pub type UCTXCPTIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IE_SPEC, UCTXCPTIE_A, O>;
...
pub struct UCAX_IE_SPEC;
impl crate::RegisterSpec for UCAX_IE_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucax_ie::R](R) reader structure"]
impl crate::Readable for UCAX_IE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucax_ie::W](W) writer structure"]
impl crate::Writable for UCAX_IE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCAxIE to value 0"]
impl crate::Resettable for UCAX_IE_SPEC {
    #[inline(always)]
