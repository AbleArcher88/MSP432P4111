...
pub struct R(crate::R<UCAX_CTLW0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCAX_CTLW0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCAX_CTLW0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCAX_CTLW0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCAxCTLW0` writer"]
pub struct W(crate::W<UCAX_CTLW0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCAX_CTLW0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCAX_CTLW0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCAX_CTLW0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCSWRST_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCSWRST_A, O>;
...
pub type UCTXBRK_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCTXBRK_A, O>;
...
pub type UCTXADDR_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCTXADDR_A, O>;
...
pub type UCDORM_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCDORM_A, O>;
...
pub type UCBRKIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCBRKIE_A, O>;
...
pub type UCRXEIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCRXEIE_A, O>;
...
pub type UCSSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, UCAX_CTLW0_SPEC, u8, UCSSEL_A, 2, O>;
...
pub type UCSYNC_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCSYNC_A, O>;
...
pub type UCMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, UCAX_CTLW0_SPEC, u8, UCMODE_A, 2, O>;
...
pub type UCSPB_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCSPB_A, O>;
...
pub type UC7BIT_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UC7BIT_A, O>;
...
pub type UCMSB_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCMSB_A, O>;
...
pub type UCPAR_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCPAR_A, O>;
...
pub type UCPEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_CTLW0_SPEC, UCPEN_A, O>;
...
pub struct UCAX_CTLW0_SPEC;
impl crate::RegisterSpec for UCAX_CTLW0_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucax_ctlw0::R](R) reader structure"]
impl crate::Readable for UCAX_CTLW0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucax_ctlw0::W](W) writer structure"]
impl crate::Writable for UCAX_CTLW0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCAxCTLW0 to value 0x01"]
impl crate::Resettable for UCAX_CTLW0_SPEC {
    #[inline(always)]
