...
pub struct R(crate::R<UCAX_TXBUF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCAX_TXBUF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCAX_TXBUF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCAX_TXBUF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCAxTXBUF` writer"]
pub struct W(crate::W<UCAX_TXBUF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCAX_TXBUF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCAX_TXBUF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCAX_TXBUF_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCTXBUF_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCAX_TXBUF_SPEC, u8, u8, 8, O>;
impl R {
...
pub struct UCAX_TXBUF_SPEC;
impl crate::RegisterSpec for UCAX_TXBUF_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucax_txbuf::R](R) reader structure"]
impl crate::Readable for UCAX_TXBUF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucax_txbuf::W](W) writer structure"]
impl crate::Writable for UCAX_TXBUF_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCAxTXBUF to value 0"]
impl crate::Resettable for UCAX_TXBUF_SPEC {
    #[inline(always)]
