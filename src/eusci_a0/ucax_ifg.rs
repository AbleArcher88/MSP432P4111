...
pub struct R(crate::R<UCAX_IFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCAX_IFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCAX_IFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCAX_IFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCAxIFG` writer"]
pub struct W(crate::W<UCAX_IFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCAX_IFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCAX_IFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCAX_IFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCRXIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IFG_SPEC, UCRXIFG_A, O>;
...
pub type UCTXIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IFG_SPEC, UCTXIFG_A, O>;
...
pub type UCSTTIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IFG_SPEC, UCSTTIFG_A, O>;
...
pub type UCTXCPTIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IFG_SPEC, UCTXCPTIFG_A, O>;
...
pub struct UCAX_IFG_SPEC;
impl crate::RegisterSpec for UCAX_IFG_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucax_ifg::R](R) reader structure"]
impl crate::Readable for UCAX_IFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucax_ifg::W](W) writer structure"]
impl crate::Writable for UCAX_IFG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCAxIFG to value 0x02"]
impl crate::Resettable for UCAX_IFG_SPEC {
    #[inline(always)]
