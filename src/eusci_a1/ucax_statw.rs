...
pub struct R(crate::R<UCAX_STATW_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCAX_STATW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCAX_STATW_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCAX_STATW_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCAxSTATW` writer"]
pub struct W(crate::W<UCAX_STATW_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCAX_STATW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCAX_STATW_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCAX_STATW_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `UCBUSY` reader - eUSCI_A busy"]
pub type UCBUSY_R = crate::BitReader<UCBUSY_ENUM_READ_A>;
#[doc = "eUSCI_A busy\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UCBUSY_ENUM_READ_A {
    #[doc = "0: eUSCI_A inactive"]
    UCBUSY_0 = 0,
    #[doc = "1: eUSCI_A transmitting or receiving"]
    UCBUSY_1 = 1,
}
impl From<UCBUSY_ENUM_READ_A> for bool {
    #[inline(always)]
    fn from(variant: UCBUSY_ENUM_READ_A) -> Self {
        variant as u8 != 0
    }
}
impl UCBUSY_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> UCBUSY_ENUM_READ_A {
        match self.bits {
            false => UCBUSY_ENUM_READ_A::UCBUSY_0,
            true => UCBUSY_ENUM_READ_A::UCBUSY_1,
        }
    }
    #[doc = "Checks if the value of the field is `UCBUSY_0`"]
    #[inline(always)]
    pub fn is_ucbusy_0(&self) -> bool {
        *self == UCBUSY_ENUM_READ_A::UCBUSY_0
    }
    #[doc = "Checks if the value of the field is `UCBUSY_1`"]
    #[inline(always)]
    pub fn is_ucbusy_1(&self) -> bool {
        *self == UCBUSY_ENUM_READ_A::UCBUSY_1
    }
}
...
pub type UCADDR_UCIDLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_STATW_SPEC, bool, O>;
...
pub type UCRXERR_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_STATW_SPEC, UCRXERR_A, O>;
...
pub type UCBRK_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_STATW_SPEC, UCBRK_A, O>;
...
pub type UCPE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_STATW_SPEC, UCPE_A, O>;
...
pub type UCOE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_STATW_SPEC, UCOE_A, O>;
...
pub type UCFE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_STATW_SPEC, UCFE_A, O>;
...
pub type UCLISTEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_STATW_SPEC, UCLISTEN_A, O>;
...
pub struct UCAX_STATW_SPEC;
impl crate::RegisterSpec for UCAX_STATW_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucax_statw::R](R) reader structure"]
impl crate::Readable for UCAX_STATW_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucax_statw::W](W) writer structure"]
impl crate::Writable for UCAX_STATW_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCAxSTATW to value 0"]
impl crate::Resettable for UCAX_STATW_SPEC {
    #[inline(always)]
