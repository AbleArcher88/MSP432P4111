...
pub struct R(crate::R<UCAX_MCTLW_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCAX_MCTLW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCAX_MCTLW_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCAX_MCTLW_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCAxMCTLW` writer"]
pub struct W(crate::W<UCAX_MCTLW_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCAX_MCTLW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCAX_MCTLW_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCAX_MCTLW_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCOS16_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_MCTLW_SPEC, UCOS16_A, O>;
...
pub type UCBRF_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCAX_MCTLW_SPEC, u8, u8, 4, O>;
...
pub type UCBRS_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCAX_MCTLW_SPEC, u8, u8, 8, O>;
impl R {
...
pub struct UCAX_MCTLW_SPEC;
impl crate::RegisterSpec for UCAX_MCTLW_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucax_mctlw::R](R) reader structure"]
impl crate::Readable for UCAX_MCTLW_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucax_mctlw::W](W) writer structure"]
impl crate::Writable for UCAX_MCTLW_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCAxMCTLW to value 0"]
impl crate::Resettable for UCAX_MCTLW_SPEC {
    #[inline(always)]
