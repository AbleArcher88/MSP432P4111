...
pub struct R(crate::R<UCAX_IRCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCAX_IRCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCAX_IRCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCAX_IRCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCAxIRCTL` writer"]
pub struct W(crate::W<UCAX_IRCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCAX_IRCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCAX_IRCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCAX_IRCTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCIREN_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IRCTL_SPEC, UCIREN_A, O>;
...
pub type UCIRTXCLK_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IRCTL_SPEC, UCIRTXCLK_A, O>;
...
pub type UCIRTXPL_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCAX_IRCTL_SPEC, u8, u8, 6, O>;
...
pub type UCIRRXFE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IRCTL_SPEC, UCIRRXFE_A, O>;
...
pub type UCIRRXPL_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAX_IRCTL_SPEC, UCIRRXPL_A, O>;
...
pub type UCIRRXFL_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCAX_IRCTL_SPEC, u8, u8, 4, O>;
impl R {
...
pub struct UCAX_IRCTL_SPEC;
impl crate::RegisterSpec for UCAX_IRCTL_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucax_irctl::R](R) reader structure"]
impl crate::Readable for UCAX_IRCTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucax_irctl::W](W) writer structure"]
impl crate::Writable for UCAX_IRCTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCAxIRCTL to value 0"]
impl crate::Resettable for UCAX_IRCTL_SPEC {
    #[inline(always)]
