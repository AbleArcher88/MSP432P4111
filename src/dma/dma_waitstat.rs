...
pub type WAITREQ_R = crate::FieldReader<u32, WAITREQ_ENUM_READ_A>;
#[doc = "Channel wait on request status.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u32)]
pub enum WAITREQ_ENUM_READ_A {
...
impl From<WAITREQ_ENUM_READ_A> for u32 {
    #[inline(always)]
    fn from(variant: WAITREQ_ENUM_READ_A) -> Self {
        variant as _
    }
}
impl WAITREQ_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<WAITREQ_ENUM_READ_A> {
        match self.bits {
            0 => Some(WAITREQ_ENUM_READ_A::WAITREQ_0),
            1 => Some(WAITREQ_ENUM_READ_A::WAITREQ_1),
            _ => None,
        }
    }
