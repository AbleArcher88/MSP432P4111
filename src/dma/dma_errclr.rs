...
pub type ERRCLR_R = crate::BitReader<ERRCLR_ENUM_READ_A>;
...
pub enum ERRCLR_ENUM_READ_A {
    #[doc = "0: dma_err is LOW"]
    ERRCLR_0_READ = 0,
    #[doc = "1: dma_err is HIGH."]
    ERRCLR_1_READ = 1,
}
impl From<ERRCLR_ENUM_READ_A> for bool {
    #[inline(always)]
    fn from(variant: ERRCLR_ENUM_READ_A) -> Self {
        variant as u8 != 0
    }
}
impl ERRCLR_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> ERRCLR_ENUM_READ_A {
        match self.bits {
            false => ERRCLR_ENUM_READ_A::ERRCLR_0_READ,
            true => ERRCLR_ENUM_READ_A::ERRCLR_1_READ,
        }
    }
    #[doc = "Checks if the value of the field is `ERRCLR_0_READ`"]
    #[inline(always)]
    pub fn is_errclr_0_read(&self) -> bool {
        *self == ERRCLR_ENUM_READ_A::ERRCLR_0_READ
    }
    #[doc = "Checks if the value of the field is `ERRCLR_1_READ`"]
    #[inline(always)]
    pub fn is_errclr_1_read(&self) -> bool {
        *self == ERRCLR_ENUM_READ_A::ERRCLR_1_READ
    }
}
#[doc = "Returns the status of dma_err, or sets the signal LOW. For test purposes, use the ERRSET register to set dma_err HIGH. Note: If you deassert dma_err at the same time as an ERROR occurs on the AHB-Lite bus, then the ERROR condition takes precedence and dma_err remains asserted.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ERRCLR_ENUM_WRITE_AW {
    #[doc = "0: No effect, status of dma_err is unchanged."]
    ERRCLR_0_WRITE = 0,
    #[doc = "1: Sets dma_err LOW."]
    ERRCLR_1_WRITE = 1,
}
impl From<ERRCLR_ENUM_WRITE_AW> for bool {
    #[inline(always)]
    fn from(variant: ERRCLR_ENUM_WRITE_AW) -> Self {
        variant as u8 != 0
    }
}
...
pub type ERRCLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DMA_ERRCLR_SPEC, ERRCLR_ENUM_WRITE_AW, O>;
impl<'a, const O: u8> ERRCLR_W<'a, O> {
    #[doc = "No effect, status of dma_err is unchanged."]
    #[inline(always)]
    pub fn errclr_0_write(self) -> &'a mut W {
        self.variant(ERRCLR_ENUM_WRITE_AW::ERRCLR_0_WRITE)
    }
    #[doc = "Sets dma_err LOW."]
    #[inline(always)]
    pub fn errclr_1_write(self) -> &'a mut W {
        self.variant(ERRCLR_ENUM_WRITE_AW::ERRCLR_1_WRITE)
    }
}
impl R {
