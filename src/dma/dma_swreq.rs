...
#[repr(u32)]
pub enum CHNL_SW_REQ_ENUM_WRITE_AW {
    #[doc = "0: Does not create a DMA request for the channel"]
    CHNL_SW_REQ_0 = 0,
    #[doc = "1: Creates a DMA request for the channel"]
    CHNL_SW_REQ_1 = 1,
}
impl From<CHNL_SW_REQ_ENUM_WRITE_AW> for u32 {
    #[inline(always)]
    fn from(variant: CHNL_SW_REQ_ENUM_WRITE_AW) -> Self {
        variant as _
    }
}
