...
pub type MASTEN_R = crate::BitReader<MASTEN_ENUM_READ_A>;
#[doc = "Enable status of the controller\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MASTEN_ENUM_READ_A {
    #[doc = "0: Controller disabled"]
    MASTEN_0 = 0,
    #[doc = "1: Controller enabled"]
    MASTEN_1 = 1,
}
impl From<MASTEN_ENUM_READ_A> for bool {
    #[inline(always)]
    fn from(variant: MASTEN_ENUM_READ_A) -> Self {
        variant as u8 != 0
    }
}
impl MASTEN_R {
...
impl From<STATE_ENUM_READ_A> for u8 {
    #[inline(always)]
    fn from(variant: STATE_ENUM_READ_A) -> Self {
        variant as _
    }
}
impl STATE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<STATE_ENUM_READ_A> {
        match self.bits {
            0 => Some(STATE_ENUM_READ_A::STATE_0),
            1 => Some(STATE_ENUM_READ_A::STATE_1),
            2 => Some(STATE_ENUM_READ_A::STATE_2),
            3 => Some(STATE_ENUM_READ_A::STATE_3),
            4 => Some(STATE_ENUM_READ_A::STATE_4),
            5 => Some(STATE_ENUM_READ_A::STATE_5),
            6 => Some(STATE_ENUM_READ_A::STATE_6),
            7 => Some(STATE_ENUM_READ_A::STATE_7),
            8 => Some(STATE_ENUM_READ_A::STATE_8),
            9 => Some(STATE_ENUM_READ_A::STATE_9),
            10 => Some(STATE_ENUM_READ_A::STATE_10),
            _ => None,
        }
    }
...
impl From<DMACHANS_ENUM_READ_A> for u8 {
    #[inline(always)]
    fn from(variant: DMACHANS_ENUM_READ_A) -> Self {
        variant as _
    }
}
impl DMACHANS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<DMACHANS_ENUM_READ_A> {
        match self.bits {
            0 => Some(DMACHANS_ENUM_READ_A::DMACHANS_0),
            1 => Some(DMACHANS_ENUM_READ_A::DMACHANS_1),
            30 => Some(DMACHANS_ENUM_READ_A::DMACHANS_30),
            31 => Some(DMACHANS_ENUM_READ_A::DMACHANS_31),
            _ => None,
        }
    }
...
pub type TESTSTAT_R = crate::FieldReader<u8, TESTSTAT_ENUM_READ_A>;
...
impl TESTSTAT_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<TESTSTAT_ENUM_READ_A> {
        match self.bits {
            0 => Some(TESTSTAT_ENUM_READ_A::TESTSTAT_0),
            1 => Some(TESTSTAT_ENUM_READ_A::TESTSTAT_1),
            _ => None,
        }
    }
