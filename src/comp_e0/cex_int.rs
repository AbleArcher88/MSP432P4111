...
pub struct R(crate::R<CEX_INT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CEX_INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CEX_INT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CEX_INT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CExINT` writer"]
pub struct W(crate::W<CEX_INT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CEX_INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CEX_INT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CEX_INT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CEIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_INT_SPEC, CEIFG_A, O>;
...
pub type CEIIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_INT_SPEC, CEIIFG_A, O>;
...
pub type CERDYIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_INT_SPEC, CERDYIFG_A, O>;
...
pub type CEIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_INT_SPEC, CEIE_A, O>;
...
pub type CEIIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_INT_SPEC, CEIIE_A, O>;
...
pub type CERDYIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_INT_SPEC, CERDYIE_A, O>;
...
pub struct CEX_INT_SPEC;
impl crate::RegisterSpec for CEX_INT_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [cex_int::R](R) reader structure"]
impl crate::Readable for CEX_INT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cex_int::W](W) writer structure"]
impl crate::Writable for CEX_INT_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CExINT to value 0"]
impl crate::Resettable for CEX_INT_SPEC {
    #[inline(always)]
