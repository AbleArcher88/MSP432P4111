...
pub struct R(crate::R<CEX_CTL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CEX_CTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CEX_CTL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CEX_CTL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CExCTL0` writer"]
pub struct W(crate::W<CEX_CTL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CEX_CTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CEX_CTL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CEX_CTL0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CEIPSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, CEX_CTL0_SPEC, u8, CEIPSEL_A, 4, O>;
...
pub type CEIPEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL0_SPEC, CEIPEN_A, O>;
...
pub type CEIMSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, CEX_CTL0_SPEC, u8, CEIMSEL_A, 4, O>;
...
pub type CEIMEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL0_SPEC, CEIMEN_A, O>;
...
pub struct CEX_CTL0_SPEC;
impl crate::RegisterSpec for CEX_CTL0_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [cex_ctl0::R](R) reader structure"]
impl crate::Readable for CEX_CTL0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cex_ctl0::W](W) writer structure"]
impl crate::Writable for CEX_CTL0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CExCTL0 to value 0"]
impl crate::Resettable for CEX_CTL0_SPEC {
    #[inline(always)]
