...
pub struct R(crate::R<CEX_CTL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CEX_CTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CEX_CTL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CEX_CTL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CExCTL1` writer"]
pub struct W(crate::W<CEX_CTL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CEX_CTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CEX_CTL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CEX_CTL1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CEOUT_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL1_SPEC, bool, O>;
...
pub type CEOUTPOL_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL1_SPEC, CEOUTPOL_A, O>;
...
pub type CEF_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL1_SPEC, CEF_A, O>;
...
pub type CEIES_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL1_SPEC, CEIES_A, O>;
...
pub type CESHORT_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL1_SPEC, CESHORT_A, O>;
...
pub type CEEX_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL1_SPEC, bool, O>;
...
pub type CEFDLY_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, CEX_CTL1_SPEC, u8, CEFDLY_A, 2, O>;
...
pub type CEPWRMD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, CEX_CTL1_SPEC, u8, CEPWRMD_A, 2, O>;
...
pub type CEON_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL1_SPEC, CEON_A, O>;
...
pub type CEMRVL_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL1_SPEC, CEMRVL_A, O>;
...
pub type CEMRVS_W<'a, const O: u8> = crate::BitWriter<'a, u16, CEX_CTL1_SPEC, CEMRVS_A, O>;
...
pub struct CEX_CTL1_SPEC;
impl crate::RegisterSpec for CEX_CTL1_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [cex_ctl1::R](R) reader structure"]
impl crate::Readable for CEX_CTL1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cex_ctl1::W](W) writer structure"]
impl crate::Writable for CEX_CTL1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CExCTL1 to value 0"]
impl crate::Resettable for CEX_CTL1_SPEC {
    #[inline(always)]
