...
pub struct R(crate::R<UCBX_RXBUF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCBX_RXBUF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCBX_RXBUF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCBX_RXBUF_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct UCBX_RXBUF_SPEC;
impl crate::RegisterSpec for UCBX_RXBUF_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucbx_rxbuf::R](R) reader structure"]
impl crate::Readable for UCBX_RXBUF_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UCBxRXBUF to value 0"]
impl crate::Resettable for UCBX_RXBUF_SPEC {
    #[inline(always)]
