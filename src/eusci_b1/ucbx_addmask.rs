...
pub struct R(crate::R<UCBX_ADDMASK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCBX_ADDMASK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCBX_ADDMASK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCBX_ADDMASK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCBxADDMASK` writer"]
pub struct W(crate::W<UCBX_ADDMASK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCBX_ADDMASK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCBX_ADDMASK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCBX_ADDMASK_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDMASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, UCBX_ADDMASK_SPEC, u16, u16, 10, O>;
impl R {
...
pub struct UCBX_ADDMASK_SPEC;
impl crate::RegisterSpec for UCBX_ADDMASK_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucbx_addmask::R](R) reader structure"]
impl crate::Readable for UCBX_ADDMASK_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucbx_addmask::W](W) writer structure"]
impl crate::Writable for UCBX_ADDMASK_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCBxADDMASK to value 0x03ff"]
impl crate::Resettable for UCBX_ADDMASK_SPEC {
    #[inline(always)]
