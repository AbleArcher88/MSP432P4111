...
pub struct R(crate::R<UCBX_TXBUF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCBX_TXBUF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCBX_TXBUF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCBX_TXBUF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCBxTXBUF` writer"]
pub struct W(crate::W<UCBX_TXBUF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCBX_TXBUF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCBX_TXBUF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCBX_TXBUF_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCTXBUF_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCBX_TXBUF_SPEC, u8, u8, 8, O>;
impl R {
...
pub struct UCBX_TXBUF_SPEC;
impl crate::RegisterSpec for UCBX_TXBUF_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucbx_txbuf::R](R) reader structure"]
impl crate::Readable for UCBX_TXBUF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucbx_txbuf::W](W) writer structure"]
impl crate::Writable for UCBX_TXBUF_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCBxTXBUF to value 0"]
impl crate::Resettable for UCBX_TXBUF_SPEC {
    #[inline(always)]
