...
pub type RTCIV_R = crate::FieldReader<u16, RTCIV_ENUM_READ_A>;
#[doc = "Real-time clock interrupt vector value\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u16)]
pub enum RTCIV_ENUM_READ_A {
...
impl From<RTCIV_ENUM_READ_A> for u16 {
    #[inline(always)]
    fn from(variant: RTCIV_ENUM_READ_A) -> Self {
        variant as _
    }
}
impl RTCIV_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<RTCIV_ENUM_READ_A> {
        match self.bits {
            0 => Some(RTCIV_ENUM_READ_A::RTCIV_0),
            2 => Some(RTCIV_ENUM_READ_A::RTCIV_2),
            4 => Some(RTCIV_ENUM_READ_A::RTCIV_4),
            6 => Some(RTCIV_ENUM_READ_A::RTCIV_6),
            8 => Some(RTCIV_ENUM_READ_A::RTCIV_8),
            10 => Some(RTCIV_ENUM_READ_A::RTCIV_10),
            12 => Some(RTCIV_ENUM_READ_A::RTCIV_12),
            _ => None,
        }
    }
