...
pub type YEAR_LOW_BYTE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `YearLowByte` writer - Year low byte. Valid values for Year are 0 to 4095."]
pub type YEAR_LOW_BYTE_W<'a, const O: u8> = crate::FieldWriter<'a, u16, RTCYEAR_SPEC, u8, u8, 8, O>;
#[doc = "Field `YearHighByte` reader - Year high byte. Valid values for Year are 0 to 4095."]
pub type YEAR_HIGH_BYTE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `YearHighByte` writer - Year high byte. Valid values for Year are 0 to 4095."]
pub type YEAR_HIGH_BYTE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, RTCYEAR_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bits 0:7 - Year low byte. Valid values for Year are 0 to 4095."]
    #[inline(always)]
    pub fn year_low_byte(&self) -> YEAR_LOW_BYTE_R {
        YEAR_LOW_BYTE_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:11 - Year high byte. Valid values for Year are 0 to 4095."]
    #[inline(always)]
    pub fn year_high_byte(&self) -> YEAR_HIGH_BYTE_R {
        YEAR_HIGH_BYTE_R::new(((self.bits >> 8) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - Year low byte. Valid values for Year are 0 to 4095."]
    #[inline(always)]
    pub fn year_low_byte(&mut self) -> YEAR_LOW_BYTE_W<0> {
        YEAR_LOW_BYTE_W::new(self)
    }
    #[doc = "Bits 8:11 - Year high byte. Valid values for Year are 0 to 4095."]
    #[inline(always)]
    pub fn year_high_byte(&mut self) -> YEAR_HIGH_BYTE_W<8> {
        YEAR_HIGH_BYTE_W::new(self)
    }
