...
pub type RTCTCOK_R = crate::BitReader<RTCTCOK_ENUM_READ_A>;
#[doc = "Real-time clock temperature compensation write OK\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RTCTCOK_ENUM_READ_A {
    #[doc = "0: Write to RTCTCMPx is unsuccessful"]
    RTCTCOK_0 = 0,
    #[doc = "1: Write to RTCTCMPx is successful"]
    RTCTCOK_1 = 1,
}
impl From<RTCTCOK_ENUM_READ_A> for bool {
    #[inline(always)]
    fn from(variant: RTCTCOK_ENUM_READ_A) -> Self {
        variant as u8 != 0
    }
}
impl RTCTCOK_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> RTCTCOK_ENUM_READ_A {
        match self.bits {
            false => RTCTCOK_ENUM_READ_A::RTCTCOK_0,
            true => RTCTCOK_ENUM_READ_A::RTCTCOK_1,
        }
    }
    #[doc = "Checks if the value of the field is `RTCTCOK_0`"]
    #[inline(always)]
    pub fn is_rtctcok_0(&self) -> bool {
        *self == RTCTCOK_ENUM_READ_A::RTCTCOK_0
    }
    #[doc = "Checks if the value of the field is `RTCTCOK_1`"]
    #[inline(always)]
    pub fn is_rtctcok_1(&self) -> bool {
        *self == RTCTCOK_ENUM_READ_A::RTCTCOK_1
    }
}
