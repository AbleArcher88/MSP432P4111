#![doc = "Peripheral access API for MSP432P4111 microcontrollers (generated using svd2rust v0.26.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
unsafe impl Send for FLCTL_A {}
impl FLCTL_A {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const flctl_a::RegisterBlock = 0x4001_1000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const flctl_a::RegisterBlock {
        Self::PTR
    }
}
impl Deref for FLCTL_A {
    type Target = flctl_a::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for FLCTL_A {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FLCTL_A").finish()
    }
}
#[doc = "FLCTL_A"]
pub mod flctl_a;
...
unsafe impl Send for LCD_F {}
impl LCD_F {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const lcd_f::RegisterBlock = 0x4001_2400 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const lcd_f::RegisterBlock {
        Self::PTR
    }
}
impl Deref for LCD_F {
    type Target = lcd_f::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for LCD_F {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LCD_F").finish()
    }
}
#[doc = "LCD_F"]
pub mod lcd_f;
#[doc = "System Control Space for ARM core: SCnSCB, SCB, SysTick, NVIC, CoreDebug, MPU, FPU"]
pub struct SYSTEM_CONTROL_SPACE {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for SYSTEM_CONTROL_SPACE {}
impl SYSTEM_CONTROL_SPACE {
    #[doc = r"Pointer to the register block"]
...
impl Deref for SYSTEM_CONTROL_SPACE {
...
impl core::fmt::Debug for SYSTEM_CONTROL_SPACE {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SYSTEM_CONTROL_SPACE").finish()
    }
}
#[doc = "System Control Space for ARM core: SCnSCB, SCB, SysTick, NVIC, CoreDebug, MPU, FPU"]
...
unsafe impl Send for SYSCTL_A {}
impl SYSCTL_A {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const sysctl_a::RegisterBlock = 0xe004_3000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const sysctl_a::RegisterBlock {
        Self::PTR
    }
}
impl Deref for SYSCTL_A {
    type Target = sysctl_a::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for SYSCTL_A {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SYSCTL_A").finish()
    }
}
#[doc = "SYSCTL_A"]
pub mod sysctl_a;
...
pub struct Peripherals {
    ...
    #[doc = "LCD_F"]
    pub LCD_F: LCD_F,
    #[doc = "SYSTEM_CONTROL_SPACE"]
    pub SYSTEM_CONTROL_SPACE: SYSTEM_CONTROL_SPACE,
    #[doc = "RSTCTL"]
    pub RSTCTL: RSTCTL,
    #[doc = "SYSCTL_A"]
    pub SYSCTL_A: SYSCTL_A,
}
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            SYSTEM_CONTROL_SPACE: SYSTEM_CONTROL_SPACE {
                _marker: PhantomData,
            },
            RSTCTL: RSTCTL {
                _marker: PhantomData,
